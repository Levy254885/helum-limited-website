...
const slides: Slide[] = [
  ...
  },
  {
    id: "inverter",
    tone: "light",
    eyebrow: "Inverters & lithium batteries",
    title: "Reliable Power.",
    accent: "Every Day.",
    body: "Hybrid inverter and lithium battery systems for homes and businesses — specified as part of a designed Helum solution.",
    href: "/products/inverters",
    cta: "Explore products",
    image: {
      src: "/photos/wall-battery.jpg",
      alt: "Wall-mounted lithium battery supplied by Helum",
    },
    captions: ["Hybrid inverters", "Lithium batteries"],
    watermark: true,
  },
  {
    id: "storage",
