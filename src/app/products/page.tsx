          ...
          <div className="wrap">
            <Reveal>
              ...
              <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/60 sm:text-lg">
                Inverters, lithium batteries, power stations, solar water heaters, solar panels and
                solar water pumps — specified as part of designed energy systems, not a detached
                catalogue.
              </p>
            </Reveal>
          </div>
