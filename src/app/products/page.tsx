...
export const metadata: Metadata = {
  title: "Products",
  description:
    "Helum supplies inverters, lithium batteries, power stations, solar panels, solar water heaters and solar water pumps as part of designed energy solutions.",
};
...
export default function ProductsPage() {
  return (
    <PageTransition>
      <PageHero
        eyebrow="Products"
        title="Inverters. Batteries. Power stations. Heaters. Panels. Pumps."
